...
namespace DotNetDbg
{
	...
	public unsafe struct IMAGEHLP_MODULE64
	{
		...
		public bool PdbUnmatched  { get { return bPdbUnmatched  != 0; } set { bPdbUnmatched  = value ? 1U : 0U; } }
		public bool DbgUnmatched  { get { return bDbgUnmatched  != 0; } set { bDbgUnmatched  = value ? 1U : 0U; } }
		public bool LineNumbers   { get { return bLineNumbers   != 0; } set { bLineNumbers   = value ? 1U : 0U; } }
		public bool GlobalSymbols { get { return bGlobalSymbols != 0; } set { bGlobalSymbols = value ? 1U : 0U; } }
		public bool TypeInfo      { get { return bTypeInfo      != 0; } set { bTypeInfo      = value ? 1U : 0U; } }
		public bool SourceIndexed { get { return bSourceIndexed != 0; } set { bSourceIndexed = value ? 1U : 0U; } }
		public bool Publics       { get { return bPublics       != 0; } set { bPublics       = value ? 1U : 0U; } }

		public string ModuleName      { get { fixed (char* moduleNamePtr      = this._ModuleName)      { return Marshal.PtrToStringUni((IntPtr)moduleNamePtr,       32); } } }
		public string ImageName       { get { fixed (char* imageNamePtr       = this._ImageName)       { return Marshal.PtrToStringUni((IntPtr)imageNamePtr,       256); } } }
		public string LoadedImageName { get { fixed (char* loadedImageNamePtr = this._LoadedImageName) { return Marshal.PtrToStringUni((IntPtr)loadedImageNamePtr, 256); } } }
		public string LoadedPdbName   { get { fixed (char* loadedPdbNamePtr   = this._LoadedPdbName)   { return Marshal.PtrToStringUni((IntPtr)loadedPdbNamePtr,   256); } } }
	}
	...
	public unsafe struct DEBUG_VALUE
	{
		...
		[FieldOffset(28)] public UInt32 Type;
	}
    ...
    {
        [FieldOffset(0)]  public UInt32 Characteristics;
        [FieldOffset(4)]  public UInt32 TimeDateStamp;
        [FieldOffset(8)]  public UInt16 MajorVersion;
        [FieldOffset(10)] public UInt16 MinorVersion;
        [FieldOffset(12)] public IMAGE_DEBUG_TYPE Type;
        [FieldOffset(16)] public UInt32 SizeOfData;
        [FieldOffset(20)] public UInt32 AddressOfRawData;
        [FieldOffset(24)] public UInt32 PointerToRawData;
    }
...
public struct CV_INFO_PDB70 
{
	...
	{
		[FieldOffset(0)] UInt32 Token;
		[FieldOffset(0)] UInt32 RVA;
	}
    ...
    public struct FPO_DATA
    {
        ...
        {
            get { return (ushort)((bitfield & 0xFF00)>>8); }
        }

        public ushort cbRegs
        {
            get { return (ushort)((bitfield & 0xE0)>>5); }
        }

        public ushort fHasSEH
        {
            get { return (ushort)((bitfield & 0x10)>>4); }
        }

        public ushort fUseBP
        {
            get { return (ushort)((bitfield & 0x8)>>3); }
        }

        public ushort reserved
        {
            get { return (ushort)((bitfield & 0x4)>>2); }
        }

        public ushort cbFrame
        {
            get { return (ushort)(bitfield & 0x3); }
        }
